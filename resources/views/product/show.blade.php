                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" name="name" class="form-control" id="productname" placeholder="Enter name" value="{{$product->name}}" readonly>
                            @error('name')
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="number" name="price" class="form-control" id="priceentry" value="{{$product->price}}" readonly>
                            @error('price')
                                <span style="color: #da0101">{{$message}}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-4">
                            ...
                            <input type="text" name="now_available" class="form-control" id="now_available" placeholder="Enter name" value="{{$product->now_available}}" readonly>
                            @error('now_available')
                                <span style="color: #da0101">{{$message}}</span>
                            @enderror
                        </div>
